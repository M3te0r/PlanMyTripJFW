...
?>
	<tr>
		...
		<td><a target="_parent" href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/PlanMyTrip/pages/guide/index.html?Id_Guide=<?php echo $guide['Id_Guide'] ?>"><?php echo($guide['Titre']); ?></a></td> <td><?php echo ($guide['Datetime']); ?></td> <td><?php
		if($guide['isValide'] == 1){
