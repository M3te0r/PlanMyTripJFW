 ...
 */
public class ActionRetrieveFont implements IAction {
    ...
    public void proceed(IContext iContext) {
        ...
        try{
            URL resourceURL = this.getClass().getResource("/../font/" + resource);
            if (resourceURL != null)
            {
                ...
                JwfErrorHandler.displayError(iContext, 404, "There is no such font");
            }
