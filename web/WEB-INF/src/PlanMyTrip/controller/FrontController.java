...
public class FrontController extends HttpServlet implements IFrontController {
	...
	public void init() {
		...
		rewriter.addRule(new RewriteRule(URIroot + "/pages/new_guide/index.html", "GET|POST", "PlanMyTrip.action.ActionNewGuide"));
		rewriter.addRule(new RewriteRule(URIroot + "/pages/new_guide/post.html", "GET|POST", "PlanMyTrip.action.ActionPostGuide"));
	}
